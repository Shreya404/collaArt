  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        className={cn(
          'mx-auto flex w-fit gap-8 rounded-2xl bg-gray-50 px-4 dark:bg-neutral-900 ',
          className
        )}
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            'absolute top-full -mt-10 left-1/2 w-fit whitespace-pre rounded-md border border-gray-200 bg-gray-100 px-2 py-0.5 text-xs text-neutral-700 dark:border-neutral-900 dark:bg-neutral-800 dark:text-white',
            className
          )}
          role='tooltip'
          style={{ x: '-40%' }}>
